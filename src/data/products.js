...
const list = [
  ...
  ['Cat Multivitamin Gel 100g', 'ক্যাট মাল্টিভিটামিন জেল', 540, 620, 'cat', 'supplements', 'Bioline'], ['Cat Deworming Tablet', 'ক্যাট ডিওয়ার্মিং ট্যাবলেট', 190, 0, 'cat', 'medicine', 'PetCare'],
  ...
  ['Dog Joint Care Supplement', 'ডগ জয়েন্ট কেয়ার সাপ্লিমেন্ট', 790, 0, 'dog', 'supplements', 'Himalaya'], ['Dog Tick & Flea Solution', 'ডগ টিক অ্যান্ড ফ্লি সল্যুশন', 450, 520, 'dog', 'medicine', 'Bioline'],
...
export const sectionDefinitions = [
  ['Everyday food', 'প্রতিদিনের খাবার', null, 'food'],
  ['Wellness supplements', 'স্বাস্থ্যকর সাপ্লিমেন্ট', null, 'supplements'],
  ['Medicine & care', 'মেডিসিন ও কেয়ার', null, 'medicine'],
  ['Playtime favourites', 'খেলার প্রিয় টয়স', null, 'toys'],
  ['Useful accessories', 'দরকারি এক্সেসরিজ', null, 'accessories']
];
